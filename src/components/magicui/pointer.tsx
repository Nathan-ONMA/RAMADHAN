"use client"
import type React from "react" // Keep this line
 ...
 */
export function Pointer({ className, style, children, ...props }: HTMLMotionProps<"div">): React.ReactElement {
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && containerRef.current) {
      ...
      if (parentElement) {
        ...
        // Define the cursor event handlers
        ...
        // Clean up the event listeners and cursor styles on component unmount
        return () => {
  ...
  }, []) // On veut que cet effet soit appelé une seule fois au montage du composant
